...
public class StrangeDustItem extends Item {

    public StrangeDustItem(Item.Properties properties) {
        super(properties);
    }

    protected String tooltipTranslationKey = "tooltip.sj_rock_mod.strangedust.tooltip";
